...
l_thigh_joint = 60/360*np.pi*2
l_calf_joint = -120/360*np.pi*2
r_thigh_joint = 60/360*np.pi*2
r_calf_joint = -120/360*np.pi*2

for i in range(1000):
    
    if i<100:
        robot.set_dofs_position(
            position = np.array([l_thigh_joint, l_calf_joint, r_thigh_joint, r_calf_joint]), 
